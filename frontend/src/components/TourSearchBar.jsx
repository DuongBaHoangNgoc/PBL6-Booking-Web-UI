...
export default function TourSearchBar({
  ...
  return (
    <section
      className={
        (isCompact ? "bg-white/90 border" : "bg-white shadow") +
        " rounded-lg " +
        (isCompact ? "p-3 mb-4" : "p-6 mb-6")
      }
    >
      <div
        className={
      ...
      >
        ...
        <div className={isCompact ? "col-span-4" : "col-span-5"}>
          ...
          >
            <FaMapMarkerAlt
              className={"text-gray-400 mr-2 " + (isCompact ? "text-sm" : "")}
            />
            <input
              type="text"
              ...
              className={
                "w-full outline-none text-gray-700 placeholder-gray-400 font-medium " +
                (isCompact ? "text-sm" : "")
              }
            />
          </div>
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <DatePicker
                ...
                customInput={
                  <DateInput value={date ? format(date, "dd/MM/yyyy") : ""} />
                }
              />
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                className={
                  "font-semibold text-gray-800 bg-transparent outline-none " +
                  (isCompact ? "text-sm" : "")
                }
              >
        ...
        <div className={isCompact ? "col-span-2" : ""}>
          <button
            ...
            className={
              ...
              " bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-lg transition-all"
            }
          >
            Tìm
          </button>
