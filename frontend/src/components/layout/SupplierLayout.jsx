  ...
  return (
    <aside className="w-64 bg-white text-gray-700 flex flex-col min-h-screen p-4 border-r border-gray-200">
      ...
      <nav className="flex flex-col space-y-1 flex-grow">
        <NavLink to="/supplier/dashboard" className={getNavLinkClass}>
          <LayoutDashboard className="w-5 h-5" />
          <span>Dashboard</span>
        </NavLink>
        <NavLink to="/supplier/tours" className={getNavLinkClass}>
      ...
      <div className="space-y-1">
        <NavLink to="/supplier/profile" className={getNavLinkClass}>
